...
use millau_runtime::{
	AccountId, AuraConfig, BalancesConfig, BridgeRococoGrandpaConfig, BridgeWestendGrandpaConfig, GenesisConfig,
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		pallet_bridge_grandpa_Instance2: BridgeRococoGrandpaConfig {
			owner: Some(get_account_id_from_seed::<sr25519::Public>("Harry")),
			..Default::default()
		},
	}
}
