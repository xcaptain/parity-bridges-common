...
//! Millau-to-Template messages sync entrypoint.
...
/// Millau-to-Template message lane.
pub type MillauMessagesToTemplate =
	SubstrateMessageLaneToSubstrate<Millau, MillauSigningParams, Template, TemplateSigningParams>;

impl SubstrateMessageLane for MillauMessagesToTemplate {
	const OUTBOUND_LANE_MESSAGES_DISPATCH_WEIGHT_METHOD: &'static str =
		bp_template::TO_TEMPLATE_MESSAGES_DISPATCH_WEIGHT_METHOD;
	const OUTBOUND_LANE_LATEST_GENERATED_NONCE_METHOD: &'static str =
		bp_template::TO_TEMPLATE_LATEST_GENERATED_NONCE_METHOD;
	const OUTBOUND_LANE_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_template::TO_TEMPLATE_LATEST_RECEIVED_NONCE_METHOD;
	...
	const BEST_FINALIZED_TARGET_HEADER_ID_AT_SOURCE: &'static str = bp_template::BEST_FINALIZED_TEMPLATE_HEADER_METHOD;
	...
	fn make_messages_receiving_proof_transaction(
		...
		_generated_at_block: TemplateHeaderId,
		...
		log::trace!(
			target: "bridge",
			"Prepared Template -> Millau confirmation transaction. Weight: {}/{}, size: {}/{}",
			call_weight,
	...
	fn make_messages_delivery_transaction(
		...
		let call: template_runtime::Call = template_runtime::MessagesCall::receive_messages_proof(
		...
		log::trace!(
			target: "bridge",
			"Prepared Millau -> Template delivery transaction. Weight: {}/{}, size: {}/{}",
			call_weight,
...
type MillauSourceClient = SubstrateMessagesSource<
	Millau,
	MillauMessagesToTemplate,
	millau_runtime::Runtime,
	millau_runtime::WithTemplateMessagesInstance,
>;

/// Template node as messages target.
type TemplateTargetClient = SubstrateMessagesTarget<
	Template,
	MillauMessagesToTemplate,
...
/// Run Millau-to-Template messages sync.
pub async fn run(
	params: MessagesRelayParams<Millau, MillauSigningParams, Template, TemplateSigningParams>,
) -> Result<(), String> {
	...
	let lane = MillauMessagesToTemplate {
	...
	let max_messages_size_in_single_batch = bp_template::max_extrinsic_size() as usize / 3;
	...
	log::info!(
		target: "bridge",
		"Starting Millau -> Template messages relay.\n\t\
	...
	messages_relay::message_lane_loop::run(
		messages_relay::message_lane_loop::Params {
			...
			target_tick: Template::AVERAGE_BLOCK_INTERVAL,
			reconnect_delay: relay_utils::relay_loop::RECONNECT_DELAY,
			stall_timeout,
			delivery_params: messages_relay::message_lane_loop::MessageDeliveryParams {
				max_unrewarded_relayer_entries_at_target: bp_template::MAX_UNREWARDED_RELAYER_ENTRIES_AT_INBOUND_LANE,
				max_unconfirmed_nonces_at_target: bp_template::MAX_UNCONFIRMED_MESSAGES_AT_INBOUND_LANE,
				max_messages_in_single_batch,
				max_messages_weight_in_single_batch,
				max_messages_size_in_single_batch,
			},
		...
		.standalone_metric(|registry, prefix| {
			FloatStorageValueMetric::<_, sp_runtime::FixedU128>::new(
				...
				sp_core::storage::StorageKey(
					millau_runtime::template_messages::TemplateToMillauConversionRate::key().to_vec(),
				),
				Some(millau_runtime::template_messages::INITIAL_TEMPLATE_TO_MILLAU_CONVERSION_RATE),
				"millau_template_to_millau_conversion_rate".into(),
				"Template to Millau tokens conversion rate (used by Template)".into(),
			)
		})?
		.into_params(),
